...
vi.mock('../lib/api', () => ({
  gmailApi: { getAuthUrl: vi.fn().mockResolvedValue({ url: 'https://accounts.google.com' }) },
}))
...
describe('GmailImportSection', () => {
  ...
  it('renders pending activity with confirm and reject buttons', () => {
    ...
    mockUsePendingImports.mockReturnValue({
      data: [{
        id: 'act-1', title: 'Flight AA123', category: 'transport',
        confirmation_number: 'XYZ789', import_status: 'pending_review',
        itinerary_day_id: 'd-1', start_time: null, end_time: null,
        location: null, latitude: null, longitude: null, notes: null,
        sort_order: 0, check_out_date: null, source: 'gmail_import',
        source_ref: 'msg-1', created_at: '2026-01-01T00:00:00Z',
      }],
      isLoading: false,
    })
    render(createElement(GmailImportSection, { tripId: 'trip-1' }), { wrapper: createWrapper() })
  ...
  it('calls confirm mutation on confirm click', async () => {
    ...
    mockUsePendingImports.mockReturnValue({
      data: [{ id: 'act-1', title: 'Hotel', category: 'lodging', confirmation_number: null,
        import_status: 'pending_review', itinerary_day_id: 'd-1', start_time: null,
        end_time: null, location: null, latitude: null, longitude: null, notes: null,
        sort_order: 0, check_out_date: null, source: 'gmail_import', source_ref: 'msg-1',
